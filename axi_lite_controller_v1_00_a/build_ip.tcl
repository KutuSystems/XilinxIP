...
set files [list \
 "[file normalize "$orig_proj_dir/sources/axi4_lite_controller.vhd"]"
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$orig_proj_dir/sources/axi4_lite_controller.vhd"
...
set_property value_validation_range_maximum {16} [ipx::get_user_parameter C_S_AXI_ADDR_WIDTH [ipx::current_core]]
set_property value_validation_range_maximum {16} [ipx::get_hdl_parameter C_S_AXI_ADDR_WIDTH [ipx::current_core]]
...
set_property value_validation_range_minimum {13} [ipx::get_user_parameter C_S_AXI_ADDR_WIDTH [ipx::current_core]]
set_property value_validation_range_minimum {13} [ipx::get_hdl_parameter C_S_AXI_ADDR_WIDTH [ipx::current_core]]
...
set_property abstraction_type_vlnv {xilinx.com:signal:clock_rtl:1.0} [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]
set_property bus_type_vlnv {xilinx.com:signal:clock:1.0} [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]
set_property display_name {S_AXI_ACLK} [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]
ipx::infer_port_maps [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]
ipx::add_port_map {CLK} [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]
ipx::add_bus_interface {A_AXI_ARESETN} [ipx::current_core]
set_property abstraction_type_vlnv {xilinx.com:signal:reset_rtl:1.0} [ipx::get_bus_interface A_AXI_ARESETN [ipx::current_core]]
set_property bus_type_vlnv {xilinx.com:signal:reset:1.0} [ipx::get_bus_interface A_AXI_ARESETN [ipx::current_core]]
set_property display_name {A_AXI_ARESETN} [ipx::get_bus_interface A_AXI_ARESETN [ipx::current_core]]
ipx::infer_port_maps [ipx::get_bus_interface A_AXI_ARESETN [ipx::current_core]]
ipx::add_bus_parameter {ASSOCIATED_BUSIF} [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]
set_property value {S_AXI_LITE} [ipx::get_bus_parameter ASSOCIATED_BUSIF [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]]
ipx::add_bus_parameter {POLARITY} [ipx::get_bus_interface A_AXI_ARESETN [ipx::current_core]]
set_property value {ACTIVE_LOW} [ipx::get_bus_parameter POLARITY [ipx::get_bus_interface A_AXI_ARESETN [ipx::current_core]]]

ipx::create_xgui_files [ipx::current_core]
ipx::infer_port_maps [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]
set_property physical_name {S_AXI_ACLK} [ipx::get_port_map CLK [ipx::get_bus_interface S_AXI_ACLK [ipx::current_core]]]
ipx::create_xgui_files [ipx::current_core]
