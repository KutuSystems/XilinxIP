...
set orig_proj_dir "../motor_controller_v1_00_a"

# Create project
create_project -force motor_controller_v1_00_a ../motor_controller_v1_00_a

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects motor_controller_v1_00_a]
...
add_files -norecurse sources/blm57180_controller.vhd
add_files -norecurse sources/blm57180_model.vhd

# Set 'sources_1' fileset properties
set obj [get_filesets sources_1]
set_property "ip_repo_paths" "../../XilinxIP" $obj
set_property "top" "motor_controller" $obj
...
add_files -norecurse sources/blm57180_tb1.vhd
...
ipx::package_project -root_dir {../motor_controller_v1_00_a}
...
ipx::unload_core {kutu.com.au:kutu:motor_controller:1.0}

puts "INFO: Project created:motor_controller_v1_00_a"
